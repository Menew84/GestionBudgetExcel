...
### Feuilles Mensuelles (ex. "Janvier 2025")

Chaque feuille mensuelle comporte :
- **En-tête** (ligne 1, fusionnée de A1 à E1) : Affiche "JANVIER 2025".
...
- **Totaux et Solde Mensuel** :
  - **Total Revenus** en cellule C3 (somme des montants de la zone Revenus, lignes 6 à 55).
  - **Total Dépenses** en cellule H3 (somme des montants de la zone Dépenses, affichés avec un “–”).
  - **Solde Mensuel** en cellule C4 = *Solde Initial + Total Revenus – Total Dépenses*.
- **Cellules de synthèse** (ligne 60 : C60, D60, E60) qui reprennent respectivement le Total Revenus, le Total Dépenses, et le Solde Mensuel. La ligne 60 est masquée.

---

## Conversion en .xlsm et Ajout des Macros VBA

Pour ajouter des cases à cocher interactives :
...
7. Pour ajouter des cases à cocher, sélectionnez une feuille mensuelle (par exemple, "Janvier 2025"), puis dans l’onglet **Développeur → Macros**, exécutez :
   - `AjouterCheckboxRevenus` pour la colonne "Payé ?" des Revenus.
   - `AjouterCheckboxDepenses` pour la colonne "Payé ?" des Dépenses.
...
2. Sélectionnez **Activer toutes les macros** (ou le paramétrage qui vous convient) et activez l'accès au **modèle d'objet du projet VBA**.
